...
import org.gkk.bioshopapp.web.interceptor.FaviconInterceptor;
...
public class ApplicationWebConfig implements WebMvcConfigurer {
    ...
    @Autowired
    public ApplicationWebConfig(TitleInterceptor titleInterceptor, FaviconInterceptor faviconInterceptor) {
